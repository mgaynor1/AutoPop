...
This model includes three cytotypes (diploid, triploids, and autotetraploids), as well as two life stages, in regards to reproductive ability (immature and mature), for a total of six stages each represented by $c_{i,j}$ where i = \{2, 3, 4\} and j = \{1,2\}.
